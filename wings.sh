...
print_header "Wait For installing wings."
...
# 2. Update GRUB
# ------------------------
print_header "wait for some time."
...
# 3. Wings install
# ------------------------
print_header "started installing wings"
...
# 4. Wings service
# ------------------------
print_header "wings service cnfing."
...
# 5. SSL Certificate
# ------------------------
print_header "ssl certificate creating."
...
# ------------------------
print_header "completed install wings."
